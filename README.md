...
- Όσον αφορά τους πελάτες, περίπου στους 3000 αρχίζουν και εμφανίζονται ελαφριές καθυστερήσεις, κυρίως στην αναζήτηση. Ο αλγόριθμος είναι Ο(n) και είναι δύσκολο να φτιαχτεί ένα απλό data structure επειδή δεν κοιτάζει μόνο το όνομα, αλλά όλα τα πεδία.

- Από άποψη optimization, αυτό που μένει είναι