...
- Μεταφορά πολλών class σε διαφορετικά αρχεία. Το SidePanel είχε ξεπεράσει τις 2000 γραμμές και σήμερα πρόσθεσα άλλες 500. Ίσως να αλλάξω τις ονομασίες των αρχείων στο μέλλον. Έγινε λίγο προχειροδουλειά σε αυτό το κομμάτι.
...
- Υλοποίηση μιας στοίβας για καλύτερη πλοήγηση. Επιτρέπει την μετακίνηση σε προηγούμενο view, οπότε πλέον υπάρχουν "go back" κουμπιά. Έχει ένα bug που πρέπει να υλοποιηθεί, εάν πηγαίνεις μπρος πίσω με διαφορετικό τρόπο από τον προβλεπώμενο.
