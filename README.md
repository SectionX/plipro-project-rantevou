...
# Στουραΐτης 04/05/2025

- Πρόσθεσα docstrings στα περισσότερα View functions, πολλά refactors, σχεδίασα και υλοποίησα ένα πιο χρήσιμο σύστημα Exceptions που λειτουργούν και ως loggers. Τώρα σκέφτομαι πως να απλοποιήσω τις συναρτήσεις στο View. Αν και συνήθως η λογική είναι απλή, υπάρχουν πολλά πάρε δώσε μεταξύ των components. Σκέφτομαι να μεταφέρω όλα τα input fields και να τα αρχικοποιήσω σε ένα module "globals", και όλα να παίρνουν απο εκεί. Επίσης για τον κώδικα του REST Api, χρησιμοποίησα Pydantic για πιο εύκολο Validation, και μάλλον θα το προσαρμόσω και στο tkinter να κάνει μετατροπές μεταξύ tk.StringVar και Sqlalchemy objects.

# Φωτεινή 09/06/2025

- Προσθήκη πανελ στατιστικών
